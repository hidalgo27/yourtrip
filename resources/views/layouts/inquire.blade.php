                    ...
                    <table cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff" align="center" width="600">
                        ...
                        <tr bgcolor="#ffffff">
                            <td valign="top" style="padding:10px 35px 0 35px;color:#ffffff">
                                <img class="CToWUd" width="350" alt="logo gotoperu" src="http://yourtrip.gotoperu.com.pe/images/logos/logo-gotoperu-3.png" style="vertical-align:top;max-width:220px">
                            </td>
                        </tr>
                        @yield('content')
                        </tbody>
        ...
        <table cellspacing="0" cellpadding="0" border="0" bgcolor="#f6f6f6" align="center" width="100%" height="50">
            ...
            <tr>
                <td style="text-align:center;font-size:12px;padding:5px 15px;color:#999999">
                    <p>
                        The ONLY Peruvian Travel Operator with direct Sales Offices in the USA
                    </p>
                    <p><a href="http://gotoperu.com" style="color:blue" target="_blank">GotoPeru</a></p>
                </td>
                <td>
                    <img class="CToWUd" width="250" alt="logo gotoperu" src="http://yourtrip.gotoperu.com.pe/images/logos/logo-ave-gotoperu.png" style="vertical-align:top;max-width:220px">
                </td>
            </tr>
            </tbody>
        </table>
