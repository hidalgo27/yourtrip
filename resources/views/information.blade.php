        ...
        <div class="container">
            <form id="r_form" role="form" method="post">
                        ...
                        <div class="card bg-light">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="r_full"  placeholder="Full Name">
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="r_contact"  placeholder="Phone">
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row mt-4">
                    <div class="col">
                        <div class="form-check text-center">
                            <button type="button" class="btn btn-lg btn-g-yellow btn-block text-white font-weight-bold" onclick="register()" id="r_submit">Send</button>
                        </div>
                    </div>
                </div>
                <div class="row mt-4">
